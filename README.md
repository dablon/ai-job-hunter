...
- **AI-powered job research** — Generates preparation guides with certifications, interview tips, and career advice for each approved job
...
│ Provider: MINIMAX                            │
╰────────────────────────────────────────────────────────╯
04:59:45 [INFO] job_hunter.researcher: Research complete for 24 jobs

╭────────────────────────────────────────────────────────╮
│ 📚              JOB PREPARATION RESEARCH              ● │
├────────────────────────────────────────────────────────┤
│ Preparation guides generated for 24 jobs                 │
╰────────────────────────────────────────────────────────╯
...
1. Staff Software Architect, LearnWith.AI (Remote) - $200,000/year USD @ Crossover
   ...
   Preparation Tips:
     • Highlight experience with LearnWith.AI's specific EdTech platform and
       AI tutoring systems if available
     • Prepare to discuss architecture of scalable learning platforms
     • Research Crossover's evaluation process — they use strict technical assessments

   Interview Process: 3 rounds: technical screen, architecture design exercise, CEO interview

   Key Responsibilities:
     • Architect scalable platform serving 1M+ users
     • Lead technical direction for AI-powered learning features

   Career Path: Staff Architect → Principal Architect → VP Engineering
...
### Email Report (HTML) — Preparation Guide Preview

Each job in the HTML email includes a **Preparation Guide** section with:

- **Certifications** — Green pill badges with recommended certifications
- **Preparation Tips** — Specific advice for the role
- **Interview Process** — Typical interview rounds
- **Key Responsibilities** — Main duties from the job description
- **Career Path** — Typical progression for the role
...
│ Source: LinkedIn | Posted: 2026-04-11             │
│ Reason: Kubernetes Platform Engineer requiring...    │
│                                                      │
│ ┌─ Preparation Guide ─────────────────────────────┐ │
│ │ Certifications:                                  │ │
│ │ [AWS Solutions Architect] [CKA] [Terraform]      │ │
│ │                                                  │ │
│ │ Preparation Tips:                                │ │
│ │ • Obtain CKA certification for Kubernetes        │ │
│ │ • Build homelab with EKS/GKE cluster             │ │
│ │ • Practice multi-cloud architecture scenarios     │ │
│ │                                                  │ │
│ │ Interview Process: Technical screen →             │ │
│ │ System design → Panel interview → Offer          │ │
│ │                                                  │ │
│ │ Career Path: Senior Engineer → Lead →             │ │
...
```bash
# Full pipeline with Minimax (default) — includes job research
...
│   ├── researcher.py      # AI job research (preparation guides)
...
5. **Job Research** — Generate preparation guides with certifications, tips, and career advice for each approved job
6. **Deduplicate** — Remove already-sent jobs
7. **Notify** — Send to enabled channels (email, Discord, etc.)
8. **Checkpoint** — Save state for resume capability
...
|----------|----------------|----------|-------|
| **Minimax** | 500 jobs | $0.02-0.10 | ~6 filter + ~20 research calls |
| **Anthropic** | 500 jobs | $0.30-0.60 | ~6 filter + ~20 research calls |
| **OpenCode** | 500 jobs | $0.00 | Requires local Ollama |

> **Note:** The research step (Step 3) adds ~20 additional API calls for job preparation guides. Use `--no-research` to skip and save credits.

### Minimax Pricing (as of 2024)

- Input: $0.01/1M tokens
- Output: $0.10/1M tokens
- A typical run with 500 jobs + research costs ~$0.05-0.10
